...
export default defineEventHandler(async (event) => {
  try {
    ...
    try {
      ...
      console.error("[GitHub API - repositories.get] Database error fetching installations:", error)
      throw createError({
        statusCode: 500,
    ...
    if (installations.length === 0) {
      console.log("[GitHub API - repositories.get] No installations found for organisation:", secure.organisationId)
      return []
    }
