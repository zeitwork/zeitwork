...
<template>
  <AlertDialogRoot v-model:open="open">
    ...
    <AlertDialogPortal>
      <AlertDialogOverlay class="fixed inset-0 z-30 bg-black/10 backdrop-blur-[5px]" />
      <AlertDialogContent
        :class="[
      ...
      >
        <div class="bg-surface border-neutral rounded-xl border">
          <AlertDialogTitle class="text-neutral border-neutral border-b px-4 py-3 text-sm font-medium">
            <slot name="title" />
          </AlertDialogTitle>
