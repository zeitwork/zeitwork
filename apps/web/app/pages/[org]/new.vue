      ...
      <div class="mx-auto w-full max-w-2xl">
        ...
        <div class="border-neutral bg-neutral rounded-lg border p-6 shadow-sm">
          <div class="mb-6">
            ...
            <a
              :href="`https://github.com/apps/zeitwork/installations/new?redirect_uri=http://localhost:3000/api/github/callback`"
              target="_blank"
              rel="noopener noreferrer"
              class="bg-neutral-subtle text-neutral hover:bg-neutral-hover block w-full rounded-md py-3 text-center font-medium transition-colors"
            >
              Add GitHub account
            </a>
          </div>
