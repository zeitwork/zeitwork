...
import (
	...
	"github.com/zeitwork/zeitwork/internal/manager"
...
func main() {
	...
	svc, err := manager.NewService(cfg, logger)
	if err != nil {
...
// handles lots of business logic
//
// for example:
// trigger new builds for new deployments
// once a deployment is ready for deployment, trigger new instances and deployment_instances
