...
SELECT d.id, d.status, d.github_commit, d.project_id, d.build_id, d.image_id, d.vm_id, d.pending_at, d.building_at, d.starting_at, d.running_at, d.stopping_at, d.stopped_at, d.failed_at, d.organisation_id, d.created_at, d.updated_at, d.deleted_at
FROM deployments d
